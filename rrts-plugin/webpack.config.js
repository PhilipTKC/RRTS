  ...
  return {
    ...
    plugins: [
      ...
      new CopyWebpackPlugin({
        patterns: [
          { from: "static/manifest.json", to: path.resolve(__dirname, "dist") },
          { from: "static/*.js", to: path.resolve(__dirname, "dist") },
          { from: "static/*.css", to: path.resolve(__dirname, "dist") },
          { from: "static/*.png", to: path.resolve(__dirname, "dist") },
          { from: "static/*.html", to: path.resolve(__dirname, "dist") },
        ],
      }),
